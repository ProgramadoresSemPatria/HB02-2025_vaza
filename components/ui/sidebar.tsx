...
export const DesktopSidebar = ({
  ...
  return (
    <div
      className={cn(
        "fixed left-0 top-0 h-screen px-4 py-4 hidden md:flex md:flex-col bg-neutral-100 dark:bg-neutral-800 w-[250px] flex-shrink-0 z-50",
        className
      )}
    >
      {children}
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className={cn(
              "fixed h-screen w-72 inset-y-0 left-0 bg-neutral-100 dark:bg-neutral-800 p-10 z-[100] flex flex-col justify-between shadow-lg overflow-hidden",
              className
            )}
          >
            <div
