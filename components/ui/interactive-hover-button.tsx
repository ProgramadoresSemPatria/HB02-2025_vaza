...
>(({ text = "Button", className, ...props }, ref) => {
  ...
  return (
    <button
      ref={ref}
      className={cn(
        "group relative w-32 cursor-pointer overflow-hidden rounded-full border bg-background p-2 text-center font-semibold hover:scale-105 transition-all duration-300",
      ...
      {...props}
    >
      <span className="inline-block translate-x-1 transition-all duration-300 group-hover:translate-x-12 group-hover:opacity-0 z-30 relative">
        {text}
      </span>
